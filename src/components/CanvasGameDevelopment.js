  ...
  render() {
    return (
      ...
      <section className="mainContainer blogContainer">
         ...
         <h2>The JS</h2>
         <p>I certainly learned a lot from <a href="https://github.com/ajarana/agame/blob/master/js/agame.js" target="_blank" rel="noopener noreferrer">the code</a> I wrote. To be frank, it's inelegant, and I could do much better if I had the time to re-write it today. There's way too much use of recursive functions, global variables, and for loops with the plethora of better options currently available these days.</p>
         ...
         <ul>
            ...
            <li><strong>Quick responsiveness for user selection on tablet and mobile devices.</strong> The default way mobile browsers take into account user selection is through the <a href="https://developer.mozilla.org/en-US/docs/Web/Events/click" target="_blank" rel="noopener noreferrer">click event</a>. My game responds to the user's <a href="https://github.com/ajarana/agame/blob/master/js/agame.js#L482-L485" target="_blank" rel="noopener noreferrer">first contact with a touchscreen</a> using <a href="https://developer.mozilla.org/en-US/docs/Web/Events/touchstart" target="_blank" rel="noopener noreferrer">touchstart</a>. Whether the user is on any device with or without touchscreen functionality, the game is immediately responsive.</li>
            <li><strong>Figuring out an algorithm for detecting adjacency.</strong> <a href="https://github.com/ajarana/agame/blob/master/js/agame.js#L360-L383" target="_blank" rel="noopener noreferrer">Green blocks are aware of other green blocks around them</a>; the same is true for blue blocks.</li>
            <li><strong>Preventing easy-to-memorize patterns.</strong> <a href="https://github.com/ajarana/agame/blob/master/js/agame.js#L100-L143" target="_blank" rel="noopener noreferrer">This</a> prevents easy patterns such as 2x2 squares in the game consisting of blocks of the same color.</li>
            <li><strong>Basic design considerations.</strong> This includes a <a href="https://github.com/ajarana/agame/blob/master/js/agame.js#L626-L644" target="_blank" rel="noopener noreferrer">point system</a>, <a href="https://github.com/ajarana/agame/blob/master/js/agame.js#L528-L566" target="_blank" rel="noopener noreferrer">checking to see if the user selected the correct block</a>, and a <a href="https://github.com/ajarana/agame/blob/master/js/agame.js#L750-L768" target="_blank" rel="noopener noreferrer">countdown</a> before the game starts.</li>
         </ul>
         <h2>Conclusions</h2>
         ...
         <h2>Credits</h2>
         <p><a href="https://adwords.googleblog.com/2015/05/building-for-next-moment.html" target="_blank" rel="noopener noreferrer">Building for the next moment</a></p>
         <p>
            <a href="https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API" target="_blank" rel="noopener noreferrer">Canvas API</a>
         </p>
         <p>
            <a href="https://developer.mozilla.org/en-US/docs/Web/Events/click" target="_blank" rel="noopener noreferrer">Click</a>
         </p>
         <p>
            <a href="https://developer.mozilla.org/en-US/docs/Web/Events/touchstart" target="_blank" rel="noopener noreferrer">Touchstart</a>
         </p>
