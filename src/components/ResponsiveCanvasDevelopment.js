    ...
    return (
      ...
      <div className="fullWidthContainerSmall backgroundGray">
         <div id="aWrapper" className="blogContainer">
           <a href="https://codepen.io/ajarana/pen/aJgPMR" target="_blank" rel="noopener noreferrer">
      ...
      <div id="blog" className="mainContainer blogContainer">
        ...
        <section>
          ...
          <ol>
            <li><strong>You can store the contents in a temporary canvas using the <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage">CanvasRenderingContext2D.drawImage()</a> method.</strong> After the original canvas width and height attributes are rescaled, you can call <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage">drawImage()</a> again in order to restore the content from the temporary canvas.</li>

            <li><strong>You can store the contents in an <a  href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/Image" rel="noopener noreferrer" target="_blank">Image object</a> using <a target="_blank" rel="noopener noreferrer"  href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLCanvasElement/toDataURL">HTMLCanvasElement.toDataURL()</a>.</strong> After the original canvas is rescaled, <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/drawImage">drawImage()</a> can be called in order to restore canvas contents. This option is very similar to the first one.</li>
...
{`\n  `}
    ...
    {`\n`}&#125;</code></pre>
          <p>Then we create some JavaScript variables to reference the necessary elements in our DOM and access the <a  href="https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D" target="_blank" rel="noopener noreferrer">2D rendering context</a> we'll use to draw shapes with.</p>
...
<span className="codePurple">var</span> ctx = <span className="codeRed">canvas</span>.<span className="codeTeal">getContext</span>(<span className="codeGreen">"2d"</span>);</code></pre>
          ...
          <p>The canvas coordinate space must be rendered according to the <a  href="https://developer.mozilla.org/en-US/docs/Web/API/Window/devicePixelRatio" target="_blank" rel="noopener noreferrer">device pixel ratio</a> of the display, otherwise the content will become blurry for any display with a device pixel ratio higher than 1. These displays are often found in mobile and tablet devices, and have more than 1 physical pixel representing every logical pixel. A more in-depth look into this subtopic can be found <a  href="https://www.html5rocks.com/en/tutorials/canvas/hidpi/" target="_blank" rel="noopener noreferrer">here</a>.</p>
          ...
          <p><span className="red">Warning:</span> A devicePixelRatio with a floating pointer number value won't always be pretty (e.g. <a  href="https://mydevice.io/devices/#samsunggalaxys6" target="_blank" rel="noopener noreferrer">Microsoft's Lumia 1520</a> with a 2.5 pixel ratio).</p>
    ...
    &#125;</code></pre>
          ...
          <ol>
            <li><strong><a target="_blank"  href="https://developer.mozilla.org/en-US/docs/Web/API/Window/innerWidth" rel="noopener noreferrer">window.innerWidth</a> and <a target="_blank"  href="https://developer.mozilla.org/en-US/docs/Web/API/Window/innerHeight" rel="noopener noreferrer">window.innerHeight</a></strong></li>
            <li><strong><a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/Window/outerWidth">window.outerWidth</a> and <a target="_blank"  href="https://developer.mozilla.org/en-US/docs/Web/API/Window/outerHeight" rel="noopener noreferrer">window.outerHeight</a></strong></li>
            <li><strong><a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/Screen/width">window.screen.width</a> and <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/Screen/height">window.screen.height</a></strong></li>
            <li><strong><a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/Screen/availWidth">window.screen.availWidth</a> and <a target="_blank" rel="noopener noreferrer" href="https://developer.mozilla.org/en-US/docs/Web/API/Screen/availHeight">window.screen.availHeight</a></strong></li>
          </ol>
...
{`\n\n  `}
    ...
    {`\n`}
&#125;</code></pre>
          <p>Setting an ID for the request allows for canceling later using <a  href="https://developer.mozilla.org/en-US/docs/Web/API/Window/cancelAnimationFrame" target="_blank" rel="noopener noreferrer">window.cancelAnimationFrame()</a>.</p>
...
<span className="codeBlue">draw</span>();</code></pre>
          <p>Events such as <a  href="https://developer.mozilla.org/en-US/docs/Web/Events/orientationchange" target="_blank" rel="noopener noreferrer">orientationchange</a> can also be used for mobile and tablet devices, but they're unreliable across browsers. For example, window.innerWidth and window.outerWidth will update properly by the time the orientationchange event ends on Safari in iOS 10, but they will not update properly on Firefox, Chrome, or Opera Mini on iOS devices.</p>

          <h2>Conclusion</h2>
          <p>Putting it all together we get something like this:  </p>
          <ul>
            <li><strong><a  href="https://codepen.io/ajarana/full/aJgPMR/" target="_blank" rel="noopener noreferrer">CodePen (Full page)</a></strong></li>
            <li><strong><a  href="https://codepen.io/ajarana/pen/aJgPMR/" target="_blank" rel="noopener noreferrer">CodePen (Editor view)</a></strong></li>
          </ul>
          ...
          <h2>Credits</h2>
          <p><a href="https://developer.mozilla.org/en-US/" target="_blank" rel="noopener noreferrer">MDN</a></p>
          <p><a  href="https://www.html5rocks.com/en/tutorials/canvas/hidpi/" target="_blank" rel="noopener noreferrer">High DPI Canvas</a></p>
          <p><a  href="https://www.html5rocks.com/en/tutorials/casestudies/gopherwoord-studios-resizing-html5-games/" target="_blank" rel="noopener noreferrer">Case Study: Auto-Resizing HTML5 Games</a></p>
          <p><a  href="https://stackoverflow.com/questions/3543358/resizing-a-html-canvas-blanks-its-contents" target="_blank" rel="noopener noreferrer">Resizing a HTML canvas blanks its contents</a></p>
